...
Value Object는 다른 객체를 속성으로 가지거나 풍부한 기능을 가질 수도 잇으며, Entity를 참조할 수도 있다. 다만 식별성을 가지는 것이 의미가 없는 객체일 뿐이다.
...
> 도메인 Service를 적절히 도입하면 응용이나 도메인, 인프라스터럭처 계층 간의 경계를 선명하게 하는 데 도움될 수 있다.